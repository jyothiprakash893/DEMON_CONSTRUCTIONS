...
<%
    ...
    if (ServletFileUpload.isMultipartContent(request)) {
        ...
        try {
            ...
            for (FileItem item : items) {
                if (item.isFormField()) {
                    ...
                    if (fieldName.equals("buildingNumber")) {
                        buildingNumber = fieldValue;
                    } else if (fieldName.equals("modelNumber")) {
                        modelNumber = fieldValue;
                    } else if (fieldName.equals("buildingType")) {
                        buildingType = fieldValue;
        ...
        try {
            ...
            String sql = "INSERT INTO buildings (building_number, model_number, building_type, floors, price, photo) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            out.println("building added successfully!");
        } catch (SQLException e) {
            out.println("An error occurred while adding the building: " + e.getMessage());
        } finally {
            // Close the resources
            try {
                if (statement != null) {
